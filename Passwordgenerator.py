...
class GUI():
    def __init__(self,master):
        ...
        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='red', bg='#ADD8E6', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#ADD8E6', fg='black')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#ADD8E6', fg='black')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#ADD8E6', fg='black')
